...
from tools.policy import validate_append_row, validate_update_cell
...
def append_row(values: list[str], actor: Optional[str] = None) -> dict:
    ...
    validate_append_row(spreadsheet_id, sheet_name, values)
...
def update_cell(cell: str, value: str, actor: Optional[str] = None) -> dict:
    ...
    validate_update_cell(spreadsheet_id, sheet_name, cell, value)
